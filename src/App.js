    ...
    return (
        <>
            <Routes>
                ...
                <Route
                    path="/project-orchestrate"
                    element={<ProjectOrchestrate />}
                />
                <Route path="/project-zotdiet" element={<ProjectZotdiet />} />
                <Route
                    path="/project-insta"
                    element={<ProjectInstaRedesign />}
                />
                <Route
                    path="/project-travelotl"
                    element={<ProjectTravelotl />}
                />
                <Route path="/project-celldogs" element={<ProjectCellDogs />} />
                <Route path="/project-teradata" element={<ProjectTeradata />} />
                <Route
                    path="/project-studentcenter"
                    element={<ProjectStudentCenter />}
                />
            </Routes>
        </>
    );
